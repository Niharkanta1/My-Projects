    ...
    public class Memory
    {
        ...
        public Memory()
        {
            ...
            if (procID.Length > 0)
            {
                ...
                Console.WriteLine("Setting " + processName + " priority to high");
            ...
            {
                Console.WriteLine("ERROR: Could not find " + processName + " process");
                Application.Exit();
            }
            ...
            if (dwmID.Length > 0)
            {
                ...
                Console.WriteLine("Setting dwm.exe priority to low");
            }
        }
        ...
        public GameObject FindTaggedObject(string objName)
        {
            ...
            do
            {
                ...
                if (i >= MAX_CT)
                {
                    Console.WriteLine("Overflow when finding tagged object: " + objName);
